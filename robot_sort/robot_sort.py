class SortingRobot:
    ...
    def sort(self):
        ...
        #     self.set_light_off()
        #     # print(f"initial held item is {self._item}")
        #     # print(f"{self._list}")
        #     while self.can_move_right():
        #         self.move_right()
        #         if self.compare_item() < 0:
        #             self.swap_item()
        #     # print(f"held item at right end is {self._item}")
        #     if self.compare_item() > 0:
        #         self.swap_item()
        #     # print(f"held item at right end going left is {self._item}")
        #     if self.can_move_left():
        #         self.move_left()
        #     while self.can_move_left() and self.compare_item() >= 0:
        #         # print(f"current item is {self._item}")
        #         self.swap_item()
        #         self.move_left()
        #         # print("swapping going left")
        #         # print(f"item is now {self._item}")

        #     while self.compare_item() != None:
        #         self.move_left()
        #         # print(f"not none so moving left")
        #         if not self.light_is_on():
        #             self.set_light_on()
        #     # print("reached None")
        #     # print(f"held item at left is {self._item}")
        #     # print(self._list)
